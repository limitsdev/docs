---
title: "Introduction"
description: "The AI Control Layer for Agentic Ecosystems"
icon: "book-open"
---
...
<img src="/images/conditionsLayout.png" alt="Limits: AI Control Layer" />

## Getting started

<CardGroup cols={2}>
  <Card title="Overview" icon="compass" href="/quickstart" iconType="solid">
    How Limits works: rules, allow/block/escalate, and your stack.
  </Card>
  <Card title="Instructions vs Conditions" icon="lightbulb" href="/policies/instructions-vs-conditions" iconType="solid">
    Two ways to define rules: structured conditions or natural-language instructions.
  </Card>
  <Card title="Quickstart" icon="rocket" href="/quickstart" iconType="solid">
    Get up and running in under 5 minutes.
  </Card>
  <Card title="Platform Guide" icon="table-cells" href="/platform/getting-started" iconType="solid">
    Learn how to use the Limits platform.
  </Card>
  <Card title="SDK Reference" icon="code" href="/sdk/installation" iconType="solid">
    Explore the SDK and define rules in your app.
  </Card>
  <Card title="LangChain integration" icon="plug" href="/sdk/langchain" iconType="solid">
...
<CardGroup cols={2}>
  <Card title="Deterministic rules" icon="shield-check" iconType="solid">
    Define rules that always execute the same way—no prompt ambiguity.
  </Card>
  <Card title="Human Approval Workflows" icon="user-check" iconType="solid">
    Require review (escalation) for sensitive agent actions.
  </Card>
  <Card title="Audit Logs" icon="scroll" iconType="solid">
    Full visibility into every check and agent decision.
  </Card>
  <Card title="Edge Interception" icon="bolt" iconType="solid">
...
<CardGroup cols={2}>
  ...
  <Card title="SDK Reference" icon="code" href="/sdk/installation" iconType="solid">
    Integrate rules in your app with the SDK.
  </Card>
  <Card title="API Reference" icon="terminal" href="/api-reference/introduction" iconType="solid">
    Call the API for evaluation and approvals.
  </Card>
</CardGroup>
