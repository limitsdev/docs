...
Check policies with text-based Instructions (e.g., LLM responses):

```typescript
const decision = await limits.checkInstructions(
...
<CardGroup cols={2}>
  ...
  <Card title="Escalations" icon="user-check" href="/sdk/escalations">
