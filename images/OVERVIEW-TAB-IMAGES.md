...
| # | Where to put | Image filename (suggested) | What the image should show |
|---|--------------|-----------------------------|----------------------------|
| 1 | **After "Install the SDK"** (before "Initialize the Client") | `quickstart-terminal.png` (optional) | **Optional:** Terminal showing `npm install @limits/sdk` and success output. |
...
## 4. **platform/instructions-vs-conditions.mdx** (Instructions vs Conditions)
