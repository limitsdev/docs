...
3. Configure locks and notifications
...
## Expression Editor (CEL Payload Editing)

Advanced users can edit CEL expressions directly:

- Use the "Payload" tab to view and edit raw CEL expressions
