---
title: "Escalations"
description: "List, approve, and decline escalation requests"
---

When a policy evaluation returns **`escalate`**, it creates an escalation request. The SDK provides methods to list and resolve these escalations.
...
Marks an escalation request as approved.
...
| --------- | -------- | -------- | ------------------------------------------------------------------------- |
| `id`      | `string` | **Yes**  | UUID of the escalation (e.g. `123e4567-e89b-12d3-a456-426614174000`). |
...
Marks an escalation request as declined.
...
| Parameter | Type     | Required | Description                 |
| --------- | -------- | -------- | --------------------------- |
| `id`      | `string` | **Yes**  | UUID of the escalation. |
