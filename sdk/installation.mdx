...
<Info>
**Integrate with LangChain.** You can use the SDK inside LangChain custom middleware to run guardrails, instructions, and conditions on your agent. See [LangChain integration](/sdk/langchain).
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="LangChain" icon="plug" href="/sdk/langchain">
    Use Limits with LangChain agents via custom middleware.
  </Card>
