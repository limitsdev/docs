...
Limits is a platform for **governing AI and agent requests** in your applications. You define policies that decide, for each request, whether to **allow**, **block**, or **escalate**—so agents and LLMs stay within the rules you set, without hard-coding logic in every service.
